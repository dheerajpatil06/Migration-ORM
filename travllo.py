					...
					<div class="destinations_container item_grid">
						...
						<div class="destination item">
							<div class="destination_image">
								<img src="{{dests.img.url}}" alt="">
								{% if dest.offer %}
								<div class="spec_offer text-center"><a href="#">Special Offer</a></div>
								{% endif %}
							</div>
							<div class="destination_content">
								<div class="destination_title"><a href="destinations.html">{{dests.name}}</a></div>
								<div class="destination_subtitle"><p>{{dests.desc}}</p></div>
...
SECRET_KEY = '#e+=1h-5vjyryzn=9w#im*q8q7k(zl*niws%5al^0h@s%n)1_-'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'dsp/static')
]
